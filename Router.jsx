...
const MM20 = withSplitting(() => import("../Routes/Client/MM20"));
const MM21 = withSplitting(() => import("../Routes/Client/MM21"));
...
const AppRouter = ({ width }) => {
  return (
    <Router>
      ...
      <Route exact path="/privacy" component={Header} />
      <Route exact path="/imprint" component={Header} />
      ...
      <Route exact path="/privacy" component={ScrollTopBtn} />
      <Route exact path="/imprint" component={ScrollTopBtn} />
      ...
      <Route exact path="/privacy" component={MM20} />
      <Route exact path="/imprint" component={MM21} />
      ...
      <Route exact path="/privacy" component={Footer} />
      <Route exact path="/imprint" component={Footer} />
